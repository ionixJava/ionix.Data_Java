...
public abstract class BatchCommandInsert<TEntity> extends BatchCommandExecuteBase<TEntity> {
    ...
    public int[] execute(Iterable<TEntity> entityList, EntityMetaDataProvider provider) {
        ...
        final int metaDataSize = this.getMetaDataSize(metaData, result);
    ...
    protected abstract int getMetaDataSize(EntityMetaData metaData, Triplet<SqlQuery, AutoGeneratedKey, FieldMetaData> result);
}
