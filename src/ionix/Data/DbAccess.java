...
public class DbAccess implements AutoCloseable {
    ...
    protected PreparedStatement prepareStatement(SqlQuery query, AutoGeneratedKey autoGeneratedKey){
        if (null == query)
    ...
    public QueryResult executeQuery(SqlQuery query) {
        ...
        Date now = new Date();
        try {
            ps = this.prepareStatement(query, null);
    ...
    public ExecuteResult executeUpdate(SqlQuery query, AutoGeneratedKey autoGeneratedKey) {
        ...
        Date now = new Date();
        try {
            ps = this.prepareStatement(query, autoGeneratedKey);
